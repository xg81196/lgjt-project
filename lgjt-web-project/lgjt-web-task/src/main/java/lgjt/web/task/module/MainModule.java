...
import lgjt.web.task.filter.UserFilter;
import lgjt.web.task.init.InitSetup;
...
@IocBy(type=ComboIocProvider.class,args={"*org.nutz.ioc.loader.json.JsonLoader","ioc/",
		  "*org.nutz.ioc.loader.annotation.AnnotationIocLoader","lgjt","*org.nutz.integration.quartz.QuartzIocLoader"})
