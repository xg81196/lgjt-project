...
public class SysUserAuth extends BaseEntity {
	 ...
	 * 未认证
	 */
	public static final Integer STATUS_AUDIT_UNVERIFIED = -1;
	 ...
	 * 审核不通过
	 */
	public static final Integer STATUS_AUDIT_NOTPASS = 2;
