...
public class SysUser extends BaseEntity {
    ...
    public void getValueForKsAdmin(KsAdmin value) {
        ...
        if(StringUtils.isNotEmpty(value.getIsClass())) {
            if(value.getIsClass().equals("1")) {
                this.groupId = value.getDepartId();
                this.orgId = value.getSuperId();
                this.comId = value.getSuperId();
            } else {
                this.orgId = value.getDepartId();
                this.comId = value.getDepartId();
            }
        } else {
            this.orgId = value.getDepartId();
            this.comId = value.getDepartId();
