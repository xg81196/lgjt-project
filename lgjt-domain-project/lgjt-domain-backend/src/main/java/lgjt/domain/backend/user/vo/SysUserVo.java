...
@Data
@Table("sys_user")
public class SysUserVo extends CaseEntity {
    ...
    @Column("household_register_name")
    ...
    @Column("technical_level_name")
    private String technicalLevelName;
    /**
     * 会籍变化类型。1 入会 4 转出 2 转入 5 除名 3 保留 6 退会
     */
    @Column("membership_change_type")
    private String membershipChangeType;
    @Column("membership_change_type_name")
    private String membershipChangeTypeName;
    /**
     * 会籍变化日期。yyyyMMDD
     */
    ...
    private String membershipChangeReason;
    @Column("membership_change_reason_name")
    private String membershipChangeReasonName;
    /**
     * 备注。
     */
    @Column("remark")
