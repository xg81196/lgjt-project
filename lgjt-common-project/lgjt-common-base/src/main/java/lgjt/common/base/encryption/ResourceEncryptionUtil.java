 ...
 */
public class ResourceEncryptionUtil {
     ...
     * @throws Exception
     */
    public static String getDecodeTimestampStringFromDecoderString(String str)throws Exception{
        return str.substring(0,SDF_PATTERN.length());
    }

    public static long getDecodeTimestampLongFromDecoderString(String str)throws Exception{
        return SDF.parse(str.substring(0,SDF_PATTERN.length())).getTime();
    }
...
//        System.out.println(length);
        String uuid="5b3f13f202531d1310447d1f";//UUID.randomUUID().toString();
        uuid="5b3f3ebd02531d4734af2dbe";
        ...
        System.out.println("解密后-时间戳"+getDecodeTimestampStringFromDecoderString(encode));
